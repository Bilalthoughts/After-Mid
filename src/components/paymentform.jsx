...
const PaymentForm = () => {
    ...
    return (
        <div className="flex justify-center items-center">
            <div className="py-5  md:px-6 2xl:px-0 flex justify-center items-center 2xl:mx-auto ">
                <div className="flex flex-col justify-start items-start w-full space-y-9">
                    

                    <div className="flex flex-col xl:flex-row justify-center xl:justify-between space-y-6 xl:space-y-0  w-full">
