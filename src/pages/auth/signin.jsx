...
function SignIn() {
    ...
    return (
	 ...
	 viewBox="0 0 227.656 227.656" space="preserve" >

	<path fill="#0071BC" d="M172.52,4.759c1.467,0.321,2.704,1.375,2.613,3.392c-0.504,10.084-1.054,20.213-3.575,30.022
